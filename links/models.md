...
- <a target="_blank" href="https://docs.github.com/en/copilot/reference/ai-models/model-hosting">Hosting of models for GitHub Copilot Chat</a> - where hosted, not used for training, no data retention, etc. (GitHub Docs)
...
### Quick Model Usage Summary

The table below is a quick summary of what's in <a target="_blank" href="https://docs.github.com/en/copilot/reference/ai-models/model-comparison">AI model comparison</a> from GitHub Docs.<br />
Click into the task link to learn more about the specific use cases suggested for each task and model.

| Task | Models to use | 
|----|----|
| <a target="_blank" href="https://docs.github.com/en/copilot/reference/ai-models/model-comparison#task-general-purpose-coding-and-writing">General-purpose coding and writing</a> | GPT-5.3-Codex, MAI-Code-1-Flash, GPT-5 mini, Raptor mini | 
| <a target="_blank" href="https://docs.github.com/en/copilot/reference/ai-models/model-comparison#task-fast-help-with-simple-or-repetitive-tasks">Fast help with simple or repetitive tasks</a> | Claude Haiku 4.5, MAI-Code-1-Flash | 
| <a target="_blank" href="https://docs.github.com/en/copilot/reference/ai-models/model-comparison#task-deep-reasoning-and-debugging">Deep reasoning and debugging</a>  | GPT-5.5, Claude Sonnet 4.6, Claude Opus 4.7/8, Gemini 3.1 Pro, GPT-5 mini |
| <a target="_blank" href="https://docs.github.com/en/copilot/reference/ai-models/model-comparison#task-working-with-visuals-diagrams-screenshots">Working with visuals (diagrams, screenshots)</a> | Claude Sonnet 4.6, Gemini 3.1 Pro, GPT-5 mini |
